...
<body>
	...
	<section id = "replyUpdate">
		...
		<div class="replyUpdateForm">
		    <form action="/updatenreply.do" method="post" class="replyUpdateForm2">
				...
				<table>
					<tbody>
						<tr>
							<td><textarea rows="7" cols="100" name="nrcontent" class="nreplycontent">${nreply.nrcontent }</textarea></td>
						</tr>
						<tr>
							<td class="writeBot">
