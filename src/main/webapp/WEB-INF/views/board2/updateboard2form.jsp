	...
	<section id="writeform">
		...
		<form action="/updateboard2.do" method="post" enctype="multipart/form-data">
			...
			<table class="writeMid">
				<tbody>
					<tr>
					<td><input type="text" name="title2" value="${board2.title2 }" id="writeTitle"></td>
				</tr>
				<tr>
					<td><textarea name="content2" id="writeContent">${board2.content2 }</textarea></td>
				</tr>
				<tr>
					<td>
						<input type="file" name="filename2">${board2.filename2 }
					</td>
				</tr>
					<tr>
						<td class="writeBot">
