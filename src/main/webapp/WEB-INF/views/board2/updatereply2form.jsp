...
<body>
	...
	<section id = "notice">
		...
		<div class="replyUpdateForm">
		    <form action="/updatereply2.do" method="post" class="replyUpdateForm2">
				<!-- 'hidden'은 ui를 만들지 않고 데이터 숨겨서 보낼때 사용 -->
				<input type="hidden" name="rno2" value="${reply2.rno2}">
				<input type="hidden" name="bno2" value="${reply2.bno2 }">
				<table>
					<tbody>
						<tr>
							<td><textarea name="rcontent2" class="replycontent">${reply2.rcontent2 }</textarea></td>
						</tr>
						<tr>
							<td class="writeBot">
