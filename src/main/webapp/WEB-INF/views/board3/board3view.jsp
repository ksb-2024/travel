		 ...
		 <div class="board-title">
	      ...
	      <div class = "boardViewForm">
	        ...
	        <div class = "under">
	          ...
	          <div class="likeReply">
	             <c:if test="${not empty sessionId}">
					<div id="likeSection">
						<div id="likeCount">
						<a href="/like3.do?bno3=${board3.bno3 }&id3=${sessionId}">
						<c:choose>
	        ...
	        <div class="crud">
				...
				<c:if test="${sessionId eq board3.username3 }">
	        ...
	        <c:forEach items="${replyList3 }" var="reply">
	          <div class = "reply">
	            ...
	            <div class = "replyer">
		              ${reply.replyer3}
	              	<div class="recrud">
		            	<c:if test="${sessionId eq reply.replyer3 and not empty admin}">
						...
						<a href="/updatereply3form.do?bno3=${board3.bno3 }&rno3=${reply.rno3 }">
	          ...
	          <div class="replyWrite">
	            <c:if test="${not empty sessionId and not empty admin}">
				<form action="/insertreply3.do" method="post" id="replyform">
					<input type="hidden" name="bno3" value="${board3.bno3 }">
					<input type="hidden" name="replyer3" value="${sessionId }">
					<p>
						<textarea name="rcontent3" class="wrcontent"
