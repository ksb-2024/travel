		...
		<section id="notice">
			...
			<form action="/write3.do" method="post" enctype="multipart/form-data">
				<table class="writeMid">
					<tbody>
						<tr>
							<td><input type="text" name="title3" id="writeTitle" placeholder="글제목"></td>
						</tr>
						<tr>
							<td><textarea name="content3" id="writeContent" placeholder="글내용"></textarea></td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td class="writeBot">
								...
								<a href="/board3list.do"><button type="button" class="writebtn">취소</button></a>
							</td>
						</tr>
					</tbody>
				</table>
