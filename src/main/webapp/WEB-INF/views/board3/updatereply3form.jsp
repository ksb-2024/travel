...
<body>
	...
	<section id = "replyUpdate">
		...
		<div class="replyUpdateForm">
		    <form action="/updatereply3.do" method="post" class="replyUpdateForm2">
				...
				<table>
					<tbody>
						<tr>
							<td><textarea rows="7" cols="100" name="rcontent3" class="replycontent">${reply3.rcontent3 }</textarea></td>
						</tr>
						<tr>
							<td class="writeBot">
