    ...
    <div class="profile">
      <c:choose>
   		<c:when test="${empty user.image}">
   			<img src="images/page.png" alt="프로필사진">
   		</c:when>
   		<c:otherwise>
      ...
      <div id="myModal" class="modal">
        <div class="modal-content">
          ...
          <!-- 프로필 사진 변경 -->
          <form id="profile_pic" name="profile_img" action="/editprofile_pic.do" method="post" enctype="multipart/form-data">
          	<input type="file" name="profile_pic">
          	<button type="button" onclick="saveProfileImg()">사진수정</button>
          </form>
          ...
          <form id="profileForm" action="/editprofile.do" method="post" name="profile" >
            ...
            <div id="my_p">
              ...
              <p><label for="id">아이디</label>
                <input type="text" id="id" name="id" value="${sessionId}" readonly=readonly></p>
              <p><label for="long">한 줄 소개</label>
                <textarea id="introduction" name="introduction">${user.introduction}</textarea></p>
      ...
      <button id="modify2" onclick="goSetting()"><i class="fa-solid fa-gear"></i></a></button>
    </div>
    <div class="select">
