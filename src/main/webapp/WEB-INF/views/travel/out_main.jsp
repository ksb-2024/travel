...
<body>
	...
	<section id="main_container">
	    ...
	    <section>
	       <!-- 국가/도시 검색 창 영역 -->
      <div id="mainPicture">
        <img src="../images/out_main/swiss-peak.jpg" alt="메인 화면">
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                      ...
                      <a href="/travel/japan"><div class="city">일본</div></a>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div id="dropdown-content2" class="dropdown-content">
                      ...
                      <a href="/travel/unitedKingdom"><div class="city2">영국</div></a>
                      ...
                      <a href="/travel/switzerland"><div class="city2">스위스</div></a>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div id="dropdown-content6" class="dropdown-content">
                      <a href="/travel/australia"><div class="city2">호주</div></a>
    ...
    <div id="visitCity">
      ...
      <div id="visitCity_image"> 
        <div class="image_datail">
          <a href="/travel/unitedKingdom"><img src="../images/out_main/tower-bridge.png" alt="영국">
          <p>영국<br>상세보기</a></p>
        </div>

        <div class="image_datail">
          <a href="/travel/switzerland"><img src="../images/out_main/swiss-mountain.png" alt="스위스">
          <p>스위스<br>상세보기</a></p>
        </div>

        <div class="image_datail">
          <a href="/travel/japan"><img src="../images/out_main/osaka-castle.png" alt="일본">
          <p>일본<br>상세보기</a></p>
        </div>

        <div class="image_datail">
          <a href="/travel/australia"><img src="../images/out_main/austraila-opera.png" alt="호주" class="image4">
          <p>호주<br>상세보기</a></p>
        </div>
      </div>
    </div>
        ...
        <div class="slide"> <!-- 배너 표시 영역 -->
          <div class="roller"> <!-- 원본 배너 -->
            <ul> <!-- 배너 데이터 -->
              ...
              <li class="slide_image">
                <a href="#"><img id="image5" src="../images/out_main/venice.jpg" alt="이탈리아"></a>
              </li>
              <li class="slide_image">
                <a href="#"><img id="image6" src="../images/out_main/cathedral.jpg" alt="유럽1"></a>
              </li>
              <li class="slide_image">
                <a href="#"><img id="image7" src="../images/out_main/restaurant.jpg" alt="유럽2"></a>
              </li>
              <li class="slide_image">
                <a href="#"><img id="image8" src="../images/out_main/eiffel.jpg" alt="유럽3"></a>
              </li>
              <li class="slide_image">
                <a href="#"><img id="image9" src="../images/out_main/prague.jpg" alt="유럽4"></a>
              </li>
              <li class="slide_image">
                <a href="#"><img id="image10" src="../images/out_main/buildings-america.jpg" alt="미국"></a>
              </li>
            </ul>
          </div>
        </div>
              ...
              <div class="slider_img">
                <div class="slider_inner">
                  ...
                  <div class="card mb-3" style="max-width: 600px;">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="../images/festival/canival.jpg" class="img-fluid rounded-start" alt="해운대빛축제">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title">쾰른 카니발</h5>
                          <hr>
                          <p class="card-text">기간(현지기준) : 2023.11.11 ~ 2023.02.15</p>
                          <p class="card-text">장소 : 독일 노르트라인베스트팔렌주 쾰른</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card mb-3" style="max-width: 600px;">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="../images/festival/lucia.png" class="img-fluid rounded-start" alt="광화문광장마켓">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title">성 루시아 축일</h5>
                          <hr>
                          <p class="card-text">기간(현지기준) : 2023.12.13</p>
                          <p class="card-text">장소 : 스웨덴 전역</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card mb-3" style="max-width: 600px;">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="../images/festival/dubai.jpg" class="img-fluid rounded-start" alt="만수천빛의거리">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title">두바이 쇼핑 페스티벌</h5>
                          <hr>
                          <p class="card-text">기간(현지기준) : 2023.12.08 ~ 2024.01.14</p>
                          <p class="card-text">장소 : 아랍에미리트 두바이</p>
                        </div>
                      </div>
                    </div>
                  </div>
